...
# sirve cuando un usuario quiere ctualzar un todo que no le pertenezca
from werkzeug.exceptions import abort
# protege los todos los endpoint, si el usuario quiere ingresar a la endpoint debe estar logueado
...
@login_required
def index():
    # busca todos los TODO que el usuario creo
    db, c = get_db()
    c.execute(
